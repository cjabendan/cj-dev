...
export default function Button({
  ...
  const baseClasses =
    "inline-flex h-7 sm:h-9 items-center justify-center rounded-xs  text-[10px] sm:text-xs font-semibold transition-all duration-200 gap-1 sm:gap-2 min-h-0 min-w-0 cursor-pointer text-center whitespace-nowrap select-none";
